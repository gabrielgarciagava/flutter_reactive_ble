...
final $typed_data.Uint8List deviceScanInfoDescriptor = $convert.base64Decode(
    'Cg5EZXZpY2VTY2FuSW5mbxIOCgJpZBgBIAEoCVICaWQSEgoEbmFtZRgCIAEoCVIEbmFtZRImCg'
    'dmYWlsdXJlGAMgASgLMgwuU2NhbkZhaWx1cmVSB2ZhaWx1cmUSMwoLc2VydmljZURhdGEYBCAD'
    'KAsyES5TZXJ2aWNlRGF0YUVudHJ5UgtzZXJ2aWNlRGF0YRIqChBtYW51ZmFjdHVyZXJEYXRhGA'
    'YgASgMUhBtYW51ZmFjdHVyZXJEYXRhEikKDHNlcnZpY2VVdWlkcxgHIAMoCzIFLlV1aWRSDHNl'
    'cnZpY2VVdWlkcxISCgRyc3NpGAUgASgFUgRyc3NpEjQKDWlzQ29ubmVjdGFibGUYCCABKAsyDi'
    '5Jc0Nvbm5lY3RhYmxlUg1pc0Nvbm5lY3RhYmxl');
...
@$core.Deprecated('Use scanFailureDescriptor instead')
const ScanFailure$json = {
  '1': 'ScanFailure',
  '2': [
    {'1': 'code', '3': 1, '4': 1, '5': 5, '10': 'code'},
    {'1': 'message', '3': 2, '4': 1, '5': 9, '10': 'message'},
    {'1': 'retryDate', '3': 3, '4': 1, '5': 4, '10': 'retryDate'},
  ],
};

/// Descriptor for `ScanFailure`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List scanFailureDescriptor = $convert.base64Decode(
    'CgtTY2FuRmFpbHVyZRISCgRjb2RlGAEgASgFUgRjb2RlEhgKB21lc3NhZ2UYAiABKAlSB21lc3'
    'NhZ2USHAoJcmV0cnlEYXRlGAMgASgEUglyZXRyeURhdGU=');
