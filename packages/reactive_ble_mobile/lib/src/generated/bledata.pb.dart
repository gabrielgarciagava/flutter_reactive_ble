...
class ScanForDevicesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<Uuid>(1, _omitFieldNames ? '' : 'serviceUuids', $pb.PbFieldType.PM,
        protoName: 'serviceUuids', subBuilder: Uuid.create)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'scanMode', $pb.PbFieldType.O3,
        protoName: 'scanMode')
...
class DeviceScanInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<ScanFailure>(3, _omitFieldNames ? '' : 'failure',
        subBuilder: ScanFailure.create)
    ..pc<ServiceDataEntry>(
        4, _omitFieldNames ? '' : 'serviceData', $pb.PbFieldType.PM,
    ...
    ..pc<Uuid>(7, _omitFieldNames ? '' : 'serviceUuids', $pb.PbFieldType.PM,
        protoName: 'serviceUuids', subBuilder: Uuid.create)
  ...
  @$pb.TagNumber(3)
  ScanFailure get failure => $_getN(2);
  @$pb.TagNumber(3)
  set failure(ScanFailure v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  ScanFailure ensureFailure() => $_ensure(2);
  ...
  @$pb.TagNumber(8)
  set isConnectable(IsConnectable v) {
    setField(8, v);
  }
...
class ConnectToDeviceRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.int>(3, _omitFieldNames ? '' : 'timeoutInMs', $pb.PbFieldType.O3,
...
class DeviceInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..a<$core.int>(
        2, _omitFieldNames ? '' : 'connectionState', $pb.PbFieldType.O3,
...
class NegotiateMtuRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'deviceId', protoName: 'deviceId')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'mtuSize', $pb.PbFieldType.O3,
        protoName: 'mtuSize')
    ..hasRequiredFields = false;
...
class CharacteristicAddress extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set serviceInstanceId($core.String v) {
    $_setString(3, v);
  }
  ...
  @$pb.TagNumber(5)
  set characteristicInstanceId($core.String v) {
    $_setString(4, v);
  }
...
class ServiceWithCharacteristics extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<Uuid>(2, _omitFieldNames ? '' : 'characteristics', $pb.PbFieldType.PM,
...
class DiscoverServicesInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<DiscoveredService>(
        2, _omitFieldNames ? '' : 'services', $pb.PbFieldType.PM,
...
class DiscoveredService extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<Uuid>(1, _omitFieldNames ? '' : 'serviceUuid',
        protoName: 'serviceUuid', subBuilder: Uuid.create)
    ..pc<Uuid>(
        2, _omitFieldNames ? '' : 'characteristicUuids', $pb.PbFieldType.PM,
        protoName: 'characteristicUuids', subBuilder: Uuid.create)
    ..pc<DiscoveredService>(
        3, _omitFieldNames ? '' : 'includedServices', $pb.PbFieldType.PM,
        protoName: 'includedServices', subBuilder: DiscoveredService.create)
    ..pc<DiscoveredCharacteristic>(
        4, _omitFieldNames ? '' : 'characteristics', $pb.PbFieldType.PM,
...
class ScanFailure extends $pb.GeneratedMessage {
  factory ScanFailure({
    $core.int? code,
    $core.String? message,
    $fixnum.Int64? retryDate,
  }) {
    final $result = create();
    if (code != null) {
      $result.code = code;
    ...
    if (retryDate != null) {
      $result.retryDate = retryDate;
    }
    return $result;
  }
  ScanFailure._() : super();
  factory ScanFailure.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ScanFailure.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ScanFailure',
      createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'code', $pb.PbFieldType.O3)
    ..aOS(2, _omitFieldNames ? '' : 'message')
    ..a<$fixnum.Int64>(
        3, _omitFieldNames ? '' : 'retryDate', $pb.PbFieldType.OU6,
        protoName: 'retryDate', defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false;

  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ScanFailure clone() => ScanFailure()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ScanFailure copyWith(void Function(ScanFailure) updates) =>
      super.copyWith((message) => updates(message as ScanFailure))
          as ScanFailure;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ScanFailure create() => ScanFailure._();
  ScanFailure createEmptyInstance() => create();
  static $pb.PbList<ScanFailure> createRepeated() => $pb.PbList<ScanFailure>();
  @$core.pragma('dart2js:noInline')
  static ScanFailure getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ScanFailure>(create);
  static ScanFailure? _defaultInstance;
  ...
  @$pb.TagNumber(3)
  $fixnum.Int64 get retryDate => $_getI64(2);
  @$pb.TagNumber(3)
  set retryDate($fixnum.Int64 v) {
    $_setInt64(2, v);
  }

  @$pb.TagNumber(3)
  $core.bool hasRetryDate() => $_has(2);
  @$pb.TagNumber(3)
  void clearRetryDate() => clearField(3);
}
...
class IsConnectable extends $pb.GeneratedMessage {
  ...
  factory IsConnectable.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory IsConnectable.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static $pb.PbList<IsConnectable> createRepeated() =>
      $pb.PbList<IsConnectable>();
  @$core.pragma('dart2js:noInline')
